...
export function Hero() {
  return (
    <section className="min-h-screen flex items-center bg-black pt-24 pb-16">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="font-display text-5xl md:text-6xl xl:text-7xl font-bold text-off-white leading-[1.05] mb-6">
              ...
              <br />
              To{' '}
              <em className="text-maroon">Co-Founder.</em>
            </h1>

            {/* Thesis */}
            <p className="font-body text-lg md:text-xl text-soft-gray leading-relaxed mb-6">
              Most people use AI like a search engine. Ask, get an answer, done. But that's not hiring an AI. That's borrowing one.
            </p>
            ...
            <div className="border border-white/10 rounded-2xl p-8 mb-10">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-body text-off-white font-semibold">$10M in Annualized Revenue</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-body text-off-white font-semibold">100,000 Chancers</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-body text-off-white font-semibold">50,000 Patrons Served</p>
